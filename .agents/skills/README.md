...
Install the Cursor or Codex `dn` skill in another repo with
`dn init agents --skill --agent cursor` / `--agent codex` (repo) or add
`--scope user` (`~/.cursor/skills/dn/` or `~/.agents/skills/dn/`). The shared
